...
// import theLoading from '../assets/theLoading.svg'

export default function Spinner() {
    const { mode } = useAuth();
    const svgFillColor = mode === 'light' ? '#000' : '#fff'; // Adjust colors as needed
    const svgStrokeColor = mode === 'light' ? '#555' : '#aaa'; // Adjust colors as needed

    return (
        <Stack sx={{ height: '100vh', opacity: 0.1 }} alignItems="center" justifyContent="center" mx="auto">
            {/* <img src={GearGif} alt="Loading" /> */}
            <svg xmlns="http://www.w3.org/2000/svg" width="415" height="228" viewBox="0 0 415 228">
                <defs>
                    <radialGradient id="radial-gradient" cx="0.5" cy="0.5" r="0.5" gradientUnits="objectBoundingBox">
                        <stop offset="0" stopColor={svgFillColor} />
                        <stop offset="1" stopColor={svgStrokeColor} />
                    </radialGradient>
                </defs>
                <g id="process" transform="translate(-492 -434)">
                    <g id="circles">
                        ...
                        <g id="Ellipse_13" data-name="Ellipse 13" transform="translate(895 567)" fill="#fff" stroke="#777" strokeWidth="2" opacity="0.3">
                            <circle cx="6" cy="6" r="6" stroke="none" />
                            <circle cx="6" cy="6" r="5" fill="none" />
                            <animate attributeName="opacity" values="0;0.6;0" dur="1.3s" repeatCount="indefinite" />
                        </g>
                        <g id="Ellipse_14" data-name="Ellipse 14" transform="translate(592 440)" fill="#fff" stroke="#777" strokeWidth="2" opacity="0.15">
                            <circle cx="6" cy="6" r="6" stroke="none" />
                            <circle cx="6" cy="6" r="5" fill="none" />
                            <animate attributeName="opacity" values="0;0.25;0" dur="1.6s" repeatCount="indefinite" />
                        </g>
                        <g id="Ellipse_10" data-name="Ellipse 10" transform="translate(845 460)" fill="#fff" stroke="#777" strokeWidth="3" opacity="0.3">
                            <circle cx="8" cy="8" r="8" stroke="none" />
                            <circle cx="8" cy="8" r="6.5" fill="none" />
                            <animate attributeName="opacity" values="0;0.6;0" dur="1.9s" repeatCount="indefinite" />
                        </g>
                        <g id="Ellipse_11" data-name="Ellipse 11" transform="translate(824 618)" fill="#fff" stroke="#777" strokeWidth="1" opacity="0.15">
                            <circle cx="4" cy="4" r="4" stroke="none" />
                            <circle cx="4" cy="4" r="3.5" fill="none" />
                            <animate attributeName="opacity" values="0;0.25;0" dur="2.2s" repeatCount="indefinite" />
                        </g>
                        <g id="Ellipse_16" data-name="Ellipse 16" transform="translate(492 517)" fill="#fff" stroke="#777" strokeWidth="1" opacity="0.3">
                            <circle cx="4" cy="4" r="4" stroke="none" />
                            <circle cx="4" cy="4" r="3.5" fill="none" />
                            <animate attributeName="opacity" values="0;0.6;0" dur="2.5s" repeatCount="indefinite" />
                        </g>
                        <g id="Ellipse_15" data-name="Ellipse 15" transform="translate(719 434)" fill="#fff" stroke="#777" strokeWidth="1" opacity="0.15">
                            <circle cx="4" cy="4" r="4" stroke="none" />
                            <circle cx="4" cy="4" r="3.5" fill="none" />
                            <animate attributeName="opacity" values="0;0.25;0" dur="2.8s" repeatCount="indefinite" />
                        </g>
                        <g id="Ellipse_12" data-name="Ellipse 12" transform="translate(521 452)" fill="#fff" stroke="#777" strokeWidth="1" opacity="0.3">
                            <circle cx="4" cy="4" r="4" stroke="none" />
                            <circle cx="4" cy="4" r="3.5" fill="none" />
